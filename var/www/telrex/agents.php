...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
		...
		<script type="text/javascript" language="javascript" charset="utf-8" src="js/table.agents.js"></script>
...
<div id="container">
		<h3>Agents</h3>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="agents" width="100%">
				<thead>
					<tr>
						<th>Queue</th>
						<th>Agent Num</th>
