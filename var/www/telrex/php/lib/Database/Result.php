...
/**
 * Perform an individual query on the database. The typical pattern for using this
 * class is to receive an instance of it as a result of using the {@link Database}
 * and {@link Query} class methods that return a result. This class should not be
