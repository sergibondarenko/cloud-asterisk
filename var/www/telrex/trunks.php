...
<link href="css/jquery.dataTables.css" rel="stylesheet">
		...
		<script type="text/javascript" language="javascript" charset="utf-8" src="js/table.trunks.js"></script>
...
<div id="container">
		<h3>Trunks</h3>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="trunks" width="100%">
				<thead>
					<tr>
						<th>Name</th>
						<th>Auth</th>
