...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
		...
		<script type="text/javascript" language="javascript" charset="utf-8" src="js/table.cdr.js"></script>
...
print("$rows imported\n");*/
?>   -->             
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="cdr" width="100%">
				<thead>
					<tr>
						<th>Calldate</th>
						<th>Clid</th>
