...
<a class="version-info"><?php echo lang::get("FileGator")?> | <?php echo lang::get("Tel-REX")?></a>
 ...
 | <a href="/telrex">Back to Config</a>
</div>
</div>
...
<div id="logo">
<a href="<?php echo gatorconf::get('base_url')?>/?cd="><img alt="filegator" src="<?php echo gatorconf::get('base_url')?>/include/views/img/tel-rex-logo.png"></a>
</div>
