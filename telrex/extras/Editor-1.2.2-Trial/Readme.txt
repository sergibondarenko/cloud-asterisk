...
Tutorials are also available, which can be very useful for getting started with Editor, particularly the initial installation, including how to setup the database connection for the examples:
	http://editor.datatables.net/tutorials/ .

Also available for Editor is Generator, a free web-based interface which allows you to enter information about a table and its fields that you wish to be editable, and Generator will create all of the code required for you:
